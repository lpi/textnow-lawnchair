...
public class DefaultLayoutProviderTest {
    ...
    public void testCustomProfileLoaded_with_sponsored_folder() throws Exception {
        writeLayoutAndLoad(new LauncherLayoutBuilder().atWorkspace(0, 1, 0).putSponsoredFolder());
        ...
        for (ItemInfo child : info.getContents()) {
            WorkspaceItemInfo workspaceChild = (WorkspaceItemInfo) child;
            assertEquals(LauncherSettings.Favorites.ITEM_TYPE_SHORTCUT, workspaceChild.itemType);
            assertEquals(true, workspaceChild.isSponsoredApp());
        }
    }
