...
public class LauncherModelHelper {
    ...
    public static class SandboxModelContext extends PreviewContext {

        private MockContentResolver mMockResolver;
        private ArrayMap<String, Object> mSpiedServices;
        ...
        public SandboxModelContext() {
            super(
                    ...
                    new InvariantDeviceProfile(
                            ApplicationProvider.getApplicationContext(),
                            InvariantDeviceProfile.getCurrentGridName(
                                    ApplicationProvider.getApplicationContext())));
        ...
        public File getDatabasePath(String name) {
            if (mDbDir == null) {
                return getBaseContext().getDatabasePath(name);
            }
            if (!mDbDir.exists()) {
                mDbDir.mkdirs();
            }
        ...
        public ContentResolver getContentResolver() {
            return mMockResolver != null ? mMockResolver : getBaseContext().getContentResolver();
        }

        @Override
        public void onDestroy() {
            if (mDbDir != null && deleteContents(mDbDir)) {
                mDbDir.delete();
            }
            super.onDestroy();
        }
        ...
        public PackageManager getPackageManager() {
            return mPm != null ? mPm : getBaseContext().getPackageManager();
        }

        @Override
        public Object getSystemService(String name) {
            Object service = mSpiedServices == null ? null : mSpiedServices.get(name);
